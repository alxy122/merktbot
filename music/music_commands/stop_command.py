"""
This module contains the StopCommand class, which represents a command
that stops the player in a Discord bot.
"""
...
class StopCommand:
    ...
    def __str__(self):
        return (f"StopCommand(name={self.name}, "
    ...
    def register_command(self) -> Callable[[Interaction], Coroutine[Any, Any, None]]:
        ...
        async def command(interaction: Interaction) -> None:
            ...
            await interaction.response.send_message("Stopped the player.")  # noqa
        return command
